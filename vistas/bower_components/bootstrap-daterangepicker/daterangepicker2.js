...
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        if (typeof options.template !== 'string' && !(options.template instanceof $))
            options.template = '<div class="daterangepicker2 dropdown-menu">' +
        ...
        this.container.find('.calendar')
            ...
            .on('click.daterangepicker2', '.daterangepicker_input input', $.proxy(this.showCalendars, this))
            .on('focus.daterangepicker2', '.daterangepicker_input input', $.proxy(this.formInputsFocused, this))
            .on('blur.daterangepicker2', '.daterangepicker_input input', $.proxy(this.formInputsBlurred, this))
            .on('change.daterangepicker2', '.daterangepicker_input input', $.proxy(this.formInputsChanged, this))
            .on('keydown.daterangepicker2', '.daterangepicker_input input', $.proxy(this.formInputsKeydown, this));
        ...
        if (this.element.is('input') || this.element.is('button')) {
            this.element.on({
                ...
                'keydown.daterangepicker2': $.proxy(this.keydown, this) //IE 11 compatibility
            });
        } else {
            this.element.on('click.daterangepicker2', $.proxy(this.toggle, this));
            this.element.on('keydown.daterangepicker2', $.proxy(this.toggle, this));
        }
    ...
    $.fn.daterangepicker2 = function(options, callback) {
        var implementOptions = $.extend(true, {}, $.fn.daterangepicker2.defaultOptions, options);
        this.each(function() {
            var el = $(this);
            if (el.data('daterangepicker2'))
                el.data('daterangepicker2').remove();
            el.data('daterangepicker2', new DateRangePicker(el, implementOptions, callback));
        });
        return this;
    };
