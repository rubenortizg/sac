...
if (localStorage.getItem("capturarRango") != null) {
  ...
  $("#daterange-btnRadicado span").html(localStorage.getItem("capturarRango"));

}else {

  $("#daterange-btnRadicado span").html('<i class="fa fa-calendar"></i> Rango de fecha');
...
$('#daterange-btnRadicado').daterangepicker(
  {
    "locale": {
        "format": "YYYY-MM-DD",
        "separator": " - ",
  ...
  function (start, end) {
    ...
    $('#daterange-btnRadicado span').html(start.format('YYYY-MM-DD') + ' / ' + end.format('YYYY-MM-DD'));

    var fechaInicial = start.format('YYYY-MM-DD');
    var fechaFinal = end.format('YYYY-MM-DD');
    var capturarRango = $("#daterange-btnRadicado span").html();

    localStorage.setItem("capturarRango", capturarRango);

    window.location = "index.php?ruta=radicados&fechaInicial="+fechaInicial+"&fechaFinal="+fechaFinal;
  }
)
